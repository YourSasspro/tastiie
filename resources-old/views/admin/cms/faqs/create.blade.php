...
@section('content')
    <x-admin.container>
        <x-admin.container-header>
            <x-admin.module-title :title="__('gen.create', ['attribute' => __('gen.faqs')])" />
            <x-admin.breadcrumb :currentPage="__('gen.faqs')" />
        </x-admin.container-header>

        <x-admin.container-body class="p-4">
            <x-forms.form id="createUser" :action="route('cms.faqs.store')">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <x-forms.form-input type="text" name="question" id="question" :value="old('question')" />
                ...
                <div class="col-md-6 mb-2">
                    <x-buttons.submit :title="__('gen.create', ['attribute' => trans('gen.faqs')])" />
                </div>
            </x-forms.form>
