...
@section('content')
    <x-admin.container>
        <x-admin.container-header>
            <x-admin.module-title :title="__('gen.create', ['attribute' => __('gen.user')])" />
            <x-admin.breadcrumb :currentPage="__('gen.users')" />
        </x-admin.container-header>

        <x-admin.container-body class="p-4">
            <x-forms.form id="createUser" :action="route('users.store')">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <x-forms.form-input type="text" name="first_name" id="first_name" :value="old('first_name')" />
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <x-forms.form-input type="text" name="last_name" id="last_name" :value="old('last_name')" />
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <x-forms.form-input type="email" name="email" id="email" :value="old('email')" />
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <x-forms.form-input type="tel" name="phone_number" id="phone_number" :value="old('phone_number')" />
                ...
                <div class="col-md-6 mb-2">
                    <x-buttons.submit :title="__('gen.create', ['attribute' => trans('gen.user')])" />
                </div>
            </x-forms.form>
