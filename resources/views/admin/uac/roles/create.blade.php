...
@section('content')
    <x-admin.container>
        <x-admin.container-header>
            <x-admin.module-title :title="__('gen.create', ['attribute' => __('gen.role')])" />
            <x-admin.breadcrumb :currentPage="__('gen.roles')" />
        </x-admin.container-header>

        <x-admin.container-body class="p-4">
            <x-forms.form id="createUser" :action="route('roles.store')">
                <div class="row">
                ...
                <div class="col-md-6 mb-2">
                    <x-buttons.submit :title="__('gen.create', ['attribute' => trans('gen.role')])" />
                </div>
            </x-forms.form>
