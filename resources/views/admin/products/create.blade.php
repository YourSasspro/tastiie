...
@section('title', trans('gen.products'))
...
@section('content')
    <x-admin.container>
        <x-admin.container-header>
            <x-admin.module-title :title="__('gen.create', ['attribute' => __('gen.products')])" />
            <x-admin.breadcrumb :currentPage="__('gen.products')" />
        </x-admin.container-header>

        <x-admin.container-body class="p-4">
            <x-forms.form id="createUser" :action="route('admin.products.store')">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <x-forms.form-input type="text" name="name" id="name" :value="old('name')" placeholder="Name" />
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <x-forms.form-textarea name="ingredients" id="ingredients" class="editor" :value="old('answer')" />
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <x-forms.form-textarea name="allergens" id="allergens" class="editor" :value="old('allergens')" />
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <x-forms.form-input type="text" name="weight" id="weight" :value="old('weight')"
                            placeholder="Weight" />
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <x-forms.form-input type="text" name="price" id="price" :value="old('price')"
                            placeholder="Price" />
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <x-forms.form-input type="text" name="quantity" id="quantity" :value="old('quantity')"
                    ...
                    <!-- <div class="col-md-6 mb-3">
                        ...
                        <x-forms.form-textarea name="expiry_date" id="expiry_date" class="editor" :value="old('expiry_date')" />
                    ...
                    {{-- <div class="col-md-12 mb-3">
                        <x-forms.form-label for="days">
                            @lang('gen.select_availability_days') <span class="text-danger">*</span>
                        </x-forms.form-label>
                        <x-forms.form-select name="days[]" :selectTitle="__('gen.select_availability_days')" id="multi_option" multiple
                        data-silent-initial-value-set="false" style="display: block !important;" required>
                        ...
                        <x-forms.input-error :messages="$errors->get('days')" />
                    </div> --}}
                    ...
                    <div class="col-md-6 mb-3 ">
                        ...
                        <x-forms.form-input type="time" name="start_time" id="start_time" :value="old('start_time')" required />
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <x-forms.form-input type="time" name="end_time" id="end_time" :value="old('end_time')" required />
                    ...
                    <div id="nutritionalValues">
                        {{-- <div class="row nutritional-values-row">
                            <div class="col-md-4 mb-3">
                                <x-forms.form-input type="text" name="nutritional_values[0][name]" id="name" placeholder="Name" />
                                <x-forms.input-error :messages="$errors->get('nutritional_values.name')" />
                            </div>
                            <div class="col-md-4 mb-3">
                                <x-forms.form-input type="text" name="nutritional_values[0][value]" id="value" placeholder="Value" />
                ...
                <div class="col-md-6 mb-2">
                    <x-buttons.submit :title="__('gen.create', ['attribute' => trans('gen.products')])" />
                </div>
            </x-forms.form>
