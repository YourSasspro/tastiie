...
@push('styles')
    <style>
        .additive-bg{
            ...
            background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("{{asset('storage/'. $extraData?->section_2_image)}}") !important;
        ...
        .idea-bg{
            ...
            background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("{{asset('storage/'. $extraData?->section_3_image)}}") !important;
            background-position: center !important;
            background-repeat: no-repeat !important;
            background-size: cover !important;
        }
    ...
    <section class="my-5 py-5">
        <div class="container mt-4">
            ...
            <div class="text-center">
                ...
                <x-misc.img :src="asset('storage/'. $extraData?->hero_image)" class="img-fluid" style="width:400px;"/>
            </div>
            ...
            <div class="row justify-content-center mt-5">
                <div class="col-md-10 mt-3">
                    <div class="additive-bg d-flex align-items-center justify-content-center p-4 p-md-5 rounded-5 w-100 text-center">
                        <div class="col-lg-8 col-12 mx-auto">
                            <h2 class="heading text-white" style="text-shadow: 0 2px 4px rgba(0,0,0,0.5);">{{$extraData?->section_2_title ?? ''}}</h2>
                            <p class="subheading text-white mt-4" style="text-shadow: 0 1px 2px rgba(0,0,0,0.5);">
            ...
            <div class="row justify-content-center mt-5">
                ...
                <div class="col-md-10 mt-3">
                    <div class="idea-bg d-flex align-items-center justify-content-center p-4 p-md-5 rounded-5 text-center">
                        <div class="col-lg-8 col-12 mx-auto">
                        <p class="subheading text-white mt-4" style="text-shadow: 0 1px 2px rgba(0,0,0,0.5);">
