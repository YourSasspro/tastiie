<footer class="pt-3 pb-1 footer bg-white" style="background: #61a94c !important;">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 mt-4">
                ...
                <ul class="subheading bluecolor-txt list-unstyled">
                    ...
                    <li class="mt-2"><a href="{{url('who-we-are')}}" class="text-decoration-none bluecolor-txt">@lang('gen.who_are_we')</a></li>
                    <li class="mt-2"><a href="{{route('faqs.index')}}" class="text-decoration-none bluecolor-txt">@lang('gen.faqs')</a></li>
                </ul>
            </div>
            <div class="col-md-3 mt-4">
