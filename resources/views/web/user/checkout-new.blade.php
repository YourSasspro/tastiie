                            ...
                            <div>
                                <div class="form-group mb-3">
                                    <x-forms.form-input type="text" name="first_name" id="first_name"
                                        ...
                                        placeholder="Saisissez votre prénom" :value="old('first_name')" />
                                ...
                                <div class="form-group mb-3">
                                    <x-forms.form-input type="text" name="last_name" id="last_name"
                                        ...
                                        placeholder="Saisissez votre nom" :value="old('last_name')" />
                                </div>
                                <div class="form-group mb-3">
                                    <x-forms.form-input type="email" name="email" id="email"
                                        class="{{ $errors->has('email') ? 'is-invalid' : '' }}" placeholder="Saisissez votre e-mail"
                                        :value="old('email')" />
                                </div>
                                <div class="form-group mb-3">
                                    <x-forms.form-input type="tel" name="phone_no" id="phone_no"
                                        class="{{ $errors->has('phone_no') ? 'is-invalid' : '' }}" placeholder="Saisissez votre numéro de téléphone"
                                        :value="old('phone_no')" />
                                </div>
                                <div class="form-group mb-3">
                                    ...
                                    <table class="table table-wishlist">
                                        <thead>
                                            <tr class="main-heading">
                                                <th colspan="2" class="start pl-30">@lang('gen.product')</th>
                                                <th class="text-center">@lang('gen.quantity')</th>
                                                <th class="text-center">@lang('gen.price')</th>
                                                <th class="end">@lang('gen.action')</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @auth
                                                ...
                                                @forelse (getAuthUser()->carts as $cart)
                                                    ...
                                                    <tr class="pt-30" data-cart-id="{{ $cart->id }}">
                                                        ...
                                                        <td class="product-des product-name">
                                                            <h6 class="product-name" style="margin-bottom: 5px;">{{ $cart->product->name }}</h6>
                                                            <p class="font-xs text-muted">@lang('gen.unit_price'): €{{ number_format($cart->product->price, 2) }}</p>
                                                        </td>
                                                        <td class="text-center" data-title="Stock">
                                                            <div class="detail-extralink">
                                                                <div class="detail-qty border radius m-auto d-flex align-items-center justify-content-between" style="max-width: 120px; padding: 5px 10px; border-radius: 20px !important; border: 1px solid #e2e2e2;">
                                                                    <a href="#" class="qty-down text-brand"><i class="fi-rs-minus-small"></i></a>
                                                                    <span class="qty-val fw-bold">{{ $cart->quantity }}</span>
                                                                    <a href="#" class="qty-up text-brand"><i class="fi-rs-plus-small"></i></a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="text-center" data-title="Price">
                                                            <h4 class="text-brand">€{{ number_format($cart->product->price * $cart->quantity, 2) }}</h4>
                                                        </td>
                                                        <td class="action text-center" data-title="Remove">
                                                            <a href="#" class="text-muted remove-cart-item" style="font-size: 18px;"><i class="fi-rs-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                @empty
                                                    <tr><td colspan="5" class="text-center py-4">@lang('gen.cart_is_empty')</td></tr>
                                                @endforelse
                                            @endauth
                                        </tbody>
                                        <tfoot>
                                            <tr>
                                                <th colspan="3" class="text-end pt-20"><h5>@lang('gen.total')</h5></th>
                                                <th colspan="2" class="text-center pt-20">
                                                    <h3 class="text-brand">€{{ number_format($total ?? 0, 2) }}</h3>
                                                </th>
                                            </tr>
                                        </tfoot>
                                    </table>
